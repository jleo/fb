 ...
 * @since 2.0
 */
public class MyKMeansPlusPlusClusterer<T extends Clusterable<T>> {
     ...
     */
    public MyKMeansPlusPlusClusterer(final Random random) {
     ...
     * @since 2.2
     */
    public MyKMeansPlusPlusClusterer(final Random random, final EmptyClusterStrategy emptyStrategy) {
        this.random        = random;
