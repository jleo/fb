...
class Sharding {
    ...
    static def keyEvent2 = ['block by', "assist by"];
...
//                    events << f
            ...
            found = keyEvent2.findResult { ke ->
                def found2 = null

                if (eventA && eventA?.indexOf(ke) != -1) {
                    found2 = [ke: keyEventAbbr.get(ke), team: "A"]
                }
                if (eventB && eventB?.indexOf(ke) != -1) {
                    found2 = [ke: keyEventAbbr.get(ke), team: "B"]
                }
                if (!found2)
                    return null
                else
